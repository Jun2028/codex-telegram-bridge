...
class TelegramUsageLimitTests(unittest.TestCase):
    ...
    def test_current_codex_model_falls_back_to_session_turn_context(self) -> None:
        self._write_records(
            {
                "type": "turn_context",
                "timestamp": "2026-08-16T10:23:51.853Z",
        ...
        self.assertEqual(current, ("gpt-5.6-sol", "max"))

    def test_current_codex_model_reads_nested_turn_context_event(self) -> None:
        self._write_records(
            {
                "type": "event_msg",
                "payload": {
        ...
        self.assertEqual(current, ("gpt-5.6-sol", "ultra"))
    ...
    def test_same_agent_session_change_is_tailed_instead_of_replayed(self) -> None:
        session_started = telegram_inbox.iso_timestamp_epoch("2026-07-17T00:00:00Z")
        assert session_started is not None
        self.meta.update(
            {
        ...
        telegram_inbox.write_json_object(
            message_state,
            {
                ...
                "session_path": "/temporary/helper/session.jsonl",
                "offset": 123,
            },
        )
